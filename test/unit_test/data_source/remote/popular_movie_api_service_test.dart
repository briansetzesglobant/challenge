...
import 'popular_movie_api_service_test.mocks.dart';
  ...
  group('ApiService test', () {
    test(
      ...
      () async {
        ...
        final response = await apiService.getPopularMoviesList();
        verify(
          client.get(
            Uri.parse(
              'https://api.themoviedb.org/3/movie/popular?api_key=385737c6d715026a1cd89526ff9d8d44',
    ...
    test(
      'getPopularMoviesList() should get generate an exception',
      () async {
