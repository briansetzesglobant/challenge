...
import 'top_rated_movie_api_service_test.mocks.dart';
...
void main() {
  ...
  group('ApiService test', () {
    test(
      ...
      () async {
        when(
          client.get(
            Uri.parse(
              'https://api.themoviedb.org/3/movie/top_rated?api_key=385737c6d715026a1cd89526ff9d8d44',
            ),
          ),
        ).thenAnswer(
        ...
        final response = await apiService.getTopRatedMoviesList();
        verify(
          client.get(
            Uri.parse(
              'https://api.themoviedb.org/3/movie/top_rated?api_key=385737c6d715026a1cd89526ff9d8d44',
    ...
    test(
      'getTopRatedMoviesList() should get generate an exception',
      () async {
