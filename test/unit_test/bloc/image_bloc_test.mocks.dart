...
// in challenge/test/unit_test/bloc/image_bloc_test.dart.
...
/// A class which mocks [ImagesStorage].
///
/// See the documentation for Mockito's code generation for more information.
class MockImagesStorage extends _i1.Mock implements _i5.ImagesStorage {
  MockImagesStorage() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<List<String>> uploadImages(List<_i6.File>? imagesList) =>
      (super.noSuchMethod(
        Invocation.method(
          #uploadImages,
          [imagesList],
